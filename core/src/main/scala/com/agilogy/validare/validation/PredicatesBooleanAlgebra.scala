...
trait PredicatesBooleanAlgebra {
  ...
  def or[I](v1: Predicate[I], v2: Predicate[I]): OrPredicate[I] = (v1, v2) match {
//    case (True, _)                                => True
//    case (_, True)                                => True
//    case (False, o)                               => o
//    case (o, False)                               => o
    ...
    case (o1, o2)                                 => OrPredicate(NonEmptyList.of(o1, o2))
  }

  def and[I](v1: Predicate[I], v2: Predicate[I]): AndPredicate[I] = (v1, v2) match {
//    case (False, _)                                 => False
//    case (_, False)                                 => False
//    case (True, o)                                  => o
//    case (o, True)                                  => o
    ...
    case (o1, o2)                                   => AndPredicate(NonEmptyList.of(o1, o2))
  }
